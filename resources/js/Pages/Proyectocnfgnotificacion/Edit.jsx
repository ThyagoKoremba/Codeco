...
const Edit = ({ auth, proyectonotif, proyectoNom }) => {
    ...
    const initialValues = {
        proyectoid: proyectonotif.proyectoid,
        sn_mail_notificacion: proyectonotif.sn_mail_notificacion,
        mail_notificacion: proyectonotif.mail_notificacion,
        sn_movil_notificacion: proyectonotif.sn_movil_notificacion,
        movil_notificacion: proyectonotif.movil_notificacion,
    }
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('proyectocnfgnotificacion.update', proyectonotif))
        console.log(data);
    }
    ...
    const [nombreProyecto, setNombreProyecto] = useState(proyectoNom);
                ...
                <div className="container">
                    <div className="card shadow-sm">
                        <div className="card-body">
                            <h1 className="mb-3">Editar Notificación</h1>
                            <div className="row">
                                <div className="col">
                                    <div className="card">
                                        <div className="card-body">
