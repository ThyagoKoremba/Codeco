...
const DetalleProyectoCap = () => {
    ...
    const novedades = registrosFiltrados.filter((registro) => registro.actividadid === 5);
    ...
    useEffect(() => {
        ...
        const actualizarDatos = () => {
            ...
            fetchData(fechaDesde, fechaHasta, parseInt(id)).then((data) => {
    ...
    const accionesFiltradasOrdenadas = accionesFiltradas.sort((a, b) => {
        // Asegúrate de que `fechayhoraregsitroctrl` sea una fecha o cadena comparable.
    ...
    const handleSelect = (accionId) => {
        const accion = novedades.find(a => a.idctrl === accionId); // Buscar la acción seleccionada
            ...
            <div>
                ...
                <div className="container mt-5">
                    ...
                    <div className="container ">
                        <strong><h2>Capacitaciones</h2></strong>
                                        ...
                                        >
                                            ...
                                            <div className="detalle-movil">
                                                {detalleAccion && accion.idctrl === detalleAccion.idctrl && (
                                                    <div className="mt-3">
                                                        <ActividadCapacitacion detalle={detalleAccion} />
                                                    </div>
                                                )}
                                            </div>
                                        </li>
...
export default DetalleProyectoCap;
